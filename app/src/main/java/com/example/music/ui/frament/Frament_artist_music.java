...
public class Frament_artist_music extends Fragment {
    ...
    private void SetVM() {
        singer_vm.Artist_Music.observe(this, new Observer<BaseRespon<Artist_Music>>() {
            @Override
            public void onChanged(BaseRespon<Artist_Music> artist_listBaseRespon) {
    ...
    private void initdata() {
        singer_vm.Get_Artist_Music(getContext(),String.valueOf(artistid),"1","30","cdc01810-189a-11ea-b707-4b7b2a81b695");
    }
